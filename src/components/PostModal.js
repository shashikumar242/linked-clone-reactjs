        ...
        <Container>
          <Content>
            ...
            <SharedContent>
              ...
              <Editor>
                ...
                <UploadImage>
                    ...
                    accept="image/gif, image/jpeg, image/png"     // accept only these type of files
                    name="image"
                    id="file"
                    style={{display:"none"}}
            ...
            <ShareCreation>
              ...
              <ShareComment>
                <AssetButton>
                  <img src="/images/share-comment.png" alt=""></img>
                  Anyone
                </AssetButton>
              </ShareComment>
...
const PostButton = styled.button`
  ...
  background: ${(props) =>
    props.disabled
      ? "rgba(0,0,0,0.8)"
      : "#0a66c2"}; // when textarea is empty go to  disable state , if not normal
